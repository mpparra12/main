...
export const navItems: NavItem[] = [
  ...
  {
    navCap: 'Exploration & Production',
    divider: true
  },
  {
    displayName: 'Wells',
    iconName: 'solar:station-minimalistic-line-duotone',
    route:'/extra/Wells',
    ...
    children: [
      ...
      {
        displayName: 'Daily Production',
         subItemIcon: true,
       // iconName: 'solar:chart-line-duotone',
      //  route: '/ui-components/badge',
        route:'/extra/DailyProduction',
        external: false,
        chip: true,
        chipClass: 'bg-light-secondary text-secondary',
       // chipContent: 'PRO',
      },
      {
        displayName: 'History',
         subItemIcon: true,
      //  iconName: 'solar:history-3-bold-duotone',
        route:'/extra/History',
...

  {
    ...
    iconName: 'solar:course-down-line-duotone',
    //route: 'forms/forms-elements',
    route: '/extra/drilling',
    chip: true,
    ...
    children: [
      {
        ...
        subItemIcon: true,
       // iconName: 'solar:sort-by-time-broken',
      ...
      },
      {
        displayName: 'Costs',
         subItemIcon: true,
       // iconName: 'solar:hand-money-broken',
        route: '/extra/Cost',
        external: false,
        chip: true,
        chipClass: 'bg-light-secondary text-secondary',
      ...
      },
      {
        displayName: 'Risk',
         subItemIcon: true,
      //  iconName: 'solar:shield-warning-broken',
        route: '/ui-components/chips',
        external: false,
        chip: true,
        chipClass: 'bg-light-secondary text-secondary',
...
{
    displayName: '🛢️ Reservoirs',
    iconName: 'solar:presentation-graph-bold-duotone',
    route: 'forms/forms-elements',
    chip: true,
    ...
    children: [
      {
        displayName: 'Volumes',
        subItemIcon: true,
       // iconName: 'solar:archive-up-line-duotone',
       //route: '/ui-components/menu',
        route: '/extra/Reservoirs',
        external: false,
        chip: true,
        chipClass: 'bg-light-secondary text-secondary',
       // chipContent: 'PRO',
      ...
      {
        displayName: 'Pressures',
         subItemIcon: true,
      //  iconName: 'solar:album-line-duotone',
      ...
      },
      {
        displayName: 'Integrity',
         subItemIcon: false,
      //  iconName: 'solar:accessibility-linear',
        route: '/ui-components/chips',
        external: false,
        chip: true,
        chipClass: 'bg-light-secondary text-secondary',
...
/*
  {
    displayName: 'Mantenimiento predictive',
    iconName: 'solar:command-line-duotone',
    route: '/ui-components/tooltips',
  },*/
{
    navCap: 'Transport & Midstream',
    divider: true
  },
  {
    displayName: 'Oil/Gas Pipelines',
    iconName: 'solar:pipette-bold-duotone', 
    route: 'forms/forms-elements',
    chip: true,
    ...
    children: [
      {
        ...
        subItemIcon: true,
        //iconName: 'solar:banknote-bold-duotone',
        route: '/extra/Ductos',
        external: false,
        chip: true,
        chipClass: 'bg-light-secondary text-secondary',
      ...
      },
      {
        displayName: 'Flow',
         subItemIcon: true,
       // iconName: 'solar:align-vertical-center-bold-duotone',
      ...
      },
      {
        displayName: 'Pressure',
         subItemIcon: true,
      //  iconName: 'solar:album-bod-duotone',
...

  {
    ...
    iconName: 'solar:accessibility-broken',
    route: 'forms/forms-elements',
    chip: true,
    ...
    children: [
      {
        displayName: 'Storage',
        subItemIcon: true,
       // iconName: 'solar:sort-by-time-broken-NO',
        route: '/extra/Logistic',
        external: false,
        chip: true,
        chipClass: 'bg-light-secondary text-secondary',
       // chipContent: 'PRO',
      },
      {
        displayName: 'Transport',
         subItemIcon: true,
       // iconName: 'solar:hand-money-broken-NO',
        route: '/ui-components/lists',
        external: false,
        chip: true,
        chipClass: 'bg-light-secondary text-secondary',
...

  {
    ...
    iconName: 'solar:monitor-camera-bold-duotone',
    route: '/extra/Fugas',
    //route: '/ui-components/tooltips',
  },
  {
    navCap: 'Refinación & Downstream',
    divider: true
  },
  {
    displayName: 'Plants',
    iconName: 'solar:buildings-2-bold-duotone',
    route: 'forms/forms-elements',
    chip: true,
    ...
    children: [
      {
        ...
        subItemIcon: true,
        //iconName: 'solar:archive-up-line-duotone-NO',
        route: '/extra/Plants',
      ...
      },
      {
        displayName: 'Availability',
         subItemIcon: true,
       // iconName: 'solar:album-line-duotone-NO',
        route: '/ui-components/lists',
        external: false,
        chip: true,
        chipClass: 'bg-light-secondary text-secondary',
      ...
      },
      {
        displayName: 'Efficiency',
         subItemIcon: true,
       // iconName: 'solar:accessibility-linear-NO',
        route: '/ui-components/chips',
        external: false,
        chip: true,
        chipClass: 'bg-light-secondary text-secondary',
  ...
  },
  {
    ...
    iconName: 'solar:gas-station-line-duotone',
    route: 'forms/forms-elements',
    chip: true,
...
{
    displayName: 'Quality',
    iconName: 'solar:high-quality-broken',
    route: 'forms/forms-elements',
    chip: true,
    ...
    children: [
        ...
        subItemIcon: true,
        iconName: 'solar:archive-up-line-duotone',
        route: '/extra/DashboardPageComponent',
      ...
      {
        displayName: 'Laboratory Parameters',
        subItemIcon: true,
        iconName: 'solar:archive-up-line-duotone',
        route: '/extra/Quality',
...
*/
  {
    navCap: 'HSE (Health, Safety & Environment)',
    divider: true
  },
    {
    ...
    route: '/extra/Incidents',
    
  },
  {
    displayName: 'Security Reports',
    iconName: 'solar:book-2-outline',
    route: '/extra/SecurityReport',
    
    //route: '/ui-components/tables',
  },

   {
    displayName: 'Emissions / Carbon footprint',
    iconName: 'solar:black-hole-2-linear',
    route: '/extra/Emisiones',

  },
    {
    navCap: '  Finance & Costs',
    divider: true
  },
  {
    displayName: 'CAPEX & OPEX',
    iconName: 'solar:black-hole-2-linear',
    route: '/extra/CostProduction',

  },
  {
    displayName: 'Comparison costs vs production',
    iconName: 'solar:black-hole-2-linear',
    route: '/extra/CostProduction',

  },
  {
        displayName: 'Forescast',
         subItemIcon: true,
        iconName: 'solar:album-line-duotone-NO',
        route: '/extra/Forecast',
        external: false,
        chip: true,
        chipClass: 'bg-light-secondary text-secondary',
       // chipContent: 'PRO',
  ...
  },
  {
    ...
    route: '/extra/Reports',
      ...
      {
    navCap: '  Configuration & Admin',
    divider: true
  },
  {
    displayName: 'Import Wells',
    iconName: 'solar:password-minimalistic-input-line-duotone',
    route: '/extra/ImportWells',
