...
import { HSETrackerData } from '../models/HSE-track-data';
import { DailyLineChartData } from '../models/daily-line-chart-data';
...
export class DashboardService {
  ...
  public loadVisitsChartData(): Observable<HSETrackerData> {
    return of({
