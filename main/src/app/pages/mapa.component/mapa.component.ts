import { Component, AfterViewInit, ViewChild, viewChild, afterEveryRender } from '@angular/core';
...
export class MapaComponent implements  AfterViewInit {
  ...
  get resumenTabla(): string {
    ...
    return `Showing ${totalVisibles} points of ${activas} layer${activas !== 1 ? 's' : ''} actives (total ${totalCargados} points loaded)`;
  }
