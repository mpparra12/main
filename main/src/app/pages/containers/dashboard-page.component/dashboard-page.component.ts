...
imports: [CommonModule, FormsModule, MatCardModule, MatSelectModule,
    MatTableModule, MatIconModule, NgApexchartsModule, AppPopularProductsComponent, AppEarningReportsComponent, AppTotalIncomeComponent, AppTotalFollowersComponent, AppSalesProfitComponent, HSETracker, DailyProductionComp],
